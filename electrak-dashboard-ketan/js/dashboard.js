(function ($) {
  ...
  $(function () {
    if ($("#performaneLine").length) {
      ...
      saleGradientBg.addColorStop(0, "rgba(0, 102, 51, 0.38)");
      saleGradientBg.addColorStop(1, "rgba(0, 102, 51, 0.02)");
      ...
      saleGradientBg2.addColorStop(0, "rgba(164, 213, 92, 0.59)");
      saleGradientBg2.addColorStop(1, "rgba(164, 213, 92, 0.03)");
      var salesTopData = {
        labels: [
          "SUN",
          "sun",
        ...
        datasets: [
          {
            ...
            backgroundColor: "rgb(164, 213, 92)",
            borderColor: ["rgb(164, 213, 92)"],
            borderWidth: 0,
            fill: true, // 3: no fill
          },
