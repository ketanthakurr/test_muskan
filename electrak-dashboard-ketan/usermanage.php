          ...
          <div class="row">
            <div class="col-sm-12">
                  ...
                  <!-- <div class="input-group">
                    ...
                    <form action="process_user.php" method="post">
                      <div class="mb-3">
                        ...
                        <input type="user" name="UserId" class="form-control" id="Useridinput" aria-describedby="emailHelp">
                        <div id="userhelp" class="form-text">Please make sure not not use a blank space.</div>
                      </div>
                      <div class="mb-3">
                      ...
                      <div class="btn-wrapper">
                        <input type="submit" value="submit" name="submit" class="btn btn-outline-success"></button>                          
                      </div>
                    </form>
                      ...
                      <!-- <table>
                          <tr>
                              ...
                              <td><input type="text" id="deviceName" name="deviceName" required></td>
                          </tr>
                          <tr>
                              <td><label for="deviceType">Device Type:</label></td>
                              <td><input type="text" id="deviceType" name="deviceType" required></td>
                          </tr>
                          <Add more device details here as needed -->
                      <!-- </table> --> 
              ...
              <table class="table table-hover">
                <thead>
                  <tr style="background-color: rgb(38, 36, 36);color: azure;">
                ...
                <tbody>
                  <!-- <tr>
                    ...
                    <td>Otto</td>
                    <td>@mdo</td>
                    <td><button class="btn btn-outline-pinterest" onclick="removeRow(this)">Remove</button></td>
                  </tr>
                  <tr>
                    <th scope="row">2</th>
                    <td>Jacob</td>
