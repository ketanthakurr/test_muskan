...
<body>
            ...
            <div class="navbar-menu-wrapper d-flex align-items-top">
                <ul class="navbar-nav">
                    <li class="nav-item font-weight-semibold d-none d-lg-block ms-0">
                        <div id="welcome_text">Good Morning, <span class="text-black fw-bold">
                                <?php
                                echo $user;
                                ?>
                            </span></div>
                        <h4 class="welcome-sub-text" id="energyTip">Loading...</h4>
                    </li>
                </ul>
                ...
                <li class="nav-item"> <a class="nav-link" href="pages/ui-features/typography.html">Typography</a></li>
                    ...
                    <li class="nav-item">
                        ...
                        <div class="collapse" id="form-elements">
                            <ul class="nav flex-column sub-menu">
                                <li class="nav-item"><a class="nav-link" href="usermanage.php">Add user</a></li>
                            </ul>
            </div>
                    </li>
                    <li class="nav-item">
                        ...
                        aria-selected="false">More</a>
                                    ...
                                    <div>
                                        <div class="btn-wrapper">
                                            ...
                                            <a href="#" class="btn export_btn me-0" id="downloadLink" onclick="window-print(); return false;"><i class=" icon-download"></i> Export</a>
                                        </div>
                                    </div>
                                </div>
                                        ...
                                        <div class="row">
                                            <div class="col-sm-12">
                                                <div class="statistics-details d-flex align-items-center justify-content-between">
                                                    <div>
                                                        <p class="statistics-title">Total Meter Reading </p>
                                                        <h3 class="rate-percentage">
                                                            <?php
                                                            echo $total_meter_reading . " KWH";
                                                            ?>
                                                        </h3>
                                                        <!-- <p class="text-danger d-flex"><i class="mdi mdi-menu-down"></i><span>-0.5%</span></p> -->
                                                    </div>
                                                    <div>
                                                        <p class="statistics-title">Total Watt Reading</p>
                                                        <h3 class="rate-percentage">
                                                            <?php
                                                            echo $total_watt_reading . " W";
                                                            ?>
                                                        </h3>
                                                        <!-- <p class="text-success d-flex"><i class="mdi mdi-menu-up"></i><span>+0.1%</span></p> -->
                                                    </div>
                                                    <div>
                                                        <p class="statistics-title">Average Current</p>
                                                        <h3 class="rate-percentage">
                                                            <?php
                                                            echo $average_current_reading . " A";
                                                            ?>
                                                        </h3>
                                                        <!-- <p class="text-danger d-flex"><i class="mdi mdi-menu-down"></i><span>68.8</span></p> -->
                                                    </div>
                                                    <div class="d-none d-md-block">
                                                        <p class="statistics-title">Total VA</p>
                                                        <h3 class="rate-percentage">
                                                            <?php
                                                            echo $total_va_reading  . " VA";
                                                            ?>
                                                        </h3>
                                                        <!-- <p class="text-success d-flex"><i class="mdi mdi-menu-down"></i><span>+0.8%</span></p> -->
                                                    </div>
                                                    <div class="d-none d-md-block">
                                                        <p class="statistics-title">VLL Average</p>
                                                        <h3 class="rate-percentage">
                                                            <?php
                                                            echo $vll_average_reading . " V";
                                                            ?>
                                                        </h3>
                                                        <!-- <p class="text-danger d-flex"><i class="mdi mdi-menu-down"></i><span>68.8</span></p> -->
                                                    </div>
                                                    <div class="d-none d-md-block">
                                                        <p class="statistics-title">PF Average</p>
                                                        <h3 class="rate-percentage">
                                                            <?php
                                                            echo $vln_average_reading . " V";
                                                            ?>
                                                        </h3>
                                                        <!-- <p class="text-success d-flex"><i class="mdi mdi-menu-down"></i><span>+0.8%</span></p> -->
                                                    </div>
                                                        ...
                                                        <div class="card card-rounded">
                                                            <div class="card-body">
                                                                <div class="d-sm-flex justify-content-between align-items-start">
                                                                    <div>
                                                                        <h3 class="card-title card-title-dash">Meter Reading</h3>
                                                                        <p class="card-subtitle card-subtitle-dash">Meter Reading in KWH</p>
                                                                    </div>
                                                                    <div id="performance-line-legend"></div>
                                                                </div>
                                                                <div id="chartdivline" class="chartdiv"></div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="col-lg-6 d-flex flex-column">
                                                <div class="row flex-grow">
                                                    <div class="col-md-6 col-lg-12 grid-margin stretch-card">
                                                        ...
                                                        <div class="card">
                                                            <div class="card-body">
                                                                <h4 class="card-title card-title-dash">Watt Comparison</h4>
                                                                <p class="card-subtitle card-subtitle-dash">Watt R Vs Watt Y vs Watt B</p>
                                                                <div id="chartdivpie" class="chartdiv"></div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="col-12 grid-margin stretch-card">
                                                        <div class="card card-rounded">
                                                            <div class="card-body">
                                                                <div class="d-sm-flex justify-content-between align-items-start">
                                                                    <div>
                                                                        <h3 class="card-title card-title-dash">Cost Variation</h3>
                                                                        <p class="card-subtitle card-subtitle-dash">Change in units consumed each month</p>
                                                                    </div>
                                                                        ...
                                                                        <div class="d-sm-flex align-items-center mt-4 justify-content-between">
                                                                            <h4 class="me-2">
                                                                                ...
                                                                                if ($changeInValue != null) {
                                                                                    echo "Change in value: " . $changeInValue . " KWH";
                                                                                } else {
                                                                                    echo "Not enough elements to calculate the change.";
                                                                                }
                                                                                ?>
                                                                            </h4>
                                                                ...
                                                                <div id="chartdivbar" class="chartdiv"></div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
    ...
    <script>
        var energyTips = <?php echo json_encode($energyTips); ?>;
        var currentIndex = 0;

        function updateEnergyTip() {
            var h3Element = document.getElementById('energyTip');
            if (energyTips.length > 0) {
                h3Element.style.opacity = 0;

                setTimeout(function() {
                    h3Element.textContent = energyTips[currentIndex];
                    currentIndex = (currentIndex + 1) % energyTips.length;
        ...
        var interval = setInterval(updateEnergyTip, 5000);
    </script>
