      ...
      <div class="navbar-menu-wrapper d-flex align-items-top">
        <ul class="navbar-nav">
          <li class="nav-item font-weight-semibold d-none d-lg-block ms-0">
            <h1 class="welcome-text">Welcome, <span class="text-black fw-bold">User</span></h1>
        ...
        <ul class="nav">
          ...
          <li class="nav-item">
            <a class="nav-link" data-bs-toggle="collapse" href="#form-elements" aria-expanded="false"
              ...
              <span class="menu-title">Master Board</span>
              <i class="menu-arrow"></i>
            </a>
            <div class="collapse" id="form-elements">
              <ul class="nav flex-column sub-menu">
                <li class="nav-item"><a class="nav-link" href="usermanage.php">Manage Users</a></li>
                <li class="nav-item"><a class="nav-link" href="devicemanage.php">Manage Devices</a></li>
              </ul>
            </div>
          </li>
          <li class="nav-item">
            ...
            <div class="col-sm-12">
              <div class="home-tab">
                <div class="content">
                  ...
                  <br>
                  <p style="font-size: large;">Enter Number of devices to be registered
                  </p>
                  ...
                  <!-- <div class="input-group">
                    ...
                    <div class="input-group-append">
                      <button class="btn btn-outline-secondary" type="button">Generate IDs</button>
                    </div>
                  </div> -->
                  ...
                  <form class="login-form" action="index.html" method="post">
                    <div class="form-group">
                      ...
                      <input class="form-control form-control-solid placeholder-no-fix TextUserId" type="Number" autocomplete="off" placeholder="Number" id="Number">
                    </div>
                    <div class="form-actions">
                      <button type="button" id="Generate" class="btn green uppercase ButtonLogIn DefaultButton">
                  ...
                  <br>
                    ...
                    <!-- Add new device form goes here -->
                    <form action="process_device.php"  method="POST">
                      <form class="forms-sample">
                        <div class="form-group">
                            <label for="deviceName">Device Name</label>
                            <input type="text" class="form-control" name="Name" id="deviceName" placeholder="Name">
                          </div>
                          <div class="form-group">
                            <label for="deviceNumber">Device Number</label>
                            <input type="text" class="form-control" name="DeviceNo" id="deviceNo" placeholder="DeviceNo">
                          </div>
                          <div class="form-group">
                          ...
                          <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="DeviceId" id="deviceID" placeholder="Device ID">
                          </div>
                          <div class="form-group">
                            <label for="yesNoDropdown">Is this your primary device </label>
                              <select name="PrimaryDevice" class="form-control" id="yesNoDropdown">
                            ...
                            <div class="btn-wrapper">
                                <input type="submit" value="submit" name="submit" class="btn btn-outline-success"> <a href="devicemanage.php"></a></button>
                            </div>
                    </form>
                  </form>
              </div>
